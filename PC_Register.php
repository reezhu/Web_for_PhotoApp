...
if (!empty($_POST)) {
    ...
    $query        = " SELECT 1 FROM app_user WHERE username = :user";
    ...
    $query = "INSERT INTO app_user ( username, password ) VALUES ( :user, :pass ) ";
	...
	<meta http-equiv=REFRESH CONTENT=1;url=PC_Login.php>
...
?>
	<h1>Register</h1> 
	<form action="PC_Register.php" method="post"> 
	    Username:<br /> 
